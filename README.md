...
``` bash
curl -s https://raw.githubusercontent.com/hrmuwanika/odoo-14-docker-compose/main/run.sh | sudo bash -s odoo-one 10014 20014
```
...
``` bash
curl -s https://raw.githubusercontent.com/hrmuwanika/odoo-14-docker-compose/main/run.sh | sudo bash -s odoo-two 11014 21014
```
